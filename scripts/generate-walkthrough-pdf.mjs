/**
 * Generates docs/QA_ORDER_STATUS_WALKTHROUGH.pdf from the HTML source.
 * Usage: node scripts/generate-walkthrough-pdf.mjs
 */
...
const htmlPath = path.join(root, 'docs', 'QA_ORDER_STATUS_WALKTHROUGH.html')
const pdfPath = path.join(root, 'docs', 'QA_ORDER_STATUS_WALKTHROUGH.pdf')
