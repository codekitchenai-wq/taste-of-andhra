/**
 * Generates docs/TASTE_OF_ANDHRA_FLOW.pdf from docs/TASTE_OF_ANDHRA_FLOW.html
 * Usage: node scripts/generate-flow-pdf.mjs
 */
...
const htmlPath = path.join(root, 'docs', 'TASTE_OF_ANDHRA_FLOW.html')
const pdfPath = path.join(root, 'docs', 'TASTE_OF_ANDHRA_FLOW.pdf')
