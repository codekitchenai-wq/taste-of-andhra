...
Please send us / fill:
1. Restaurant profile — name, address, phone, GSTIN, FSSAI, hours (template attached).
2. Menu spreadsheet — one row per dish (CSV template attached).
