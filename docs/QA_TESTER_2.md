# The Taste of Andhra — Tester 2 Guide

**Site:** https://www.thetasteofandhra.com  
**Shared password (all accounts):** `Test@123`  
**Your tester ID:** Tester 2  

Use **only** the Tester 2 accounts below so you do not clash with Tester 1.
...
| Field | Value |
|-------|--------|
| Email / User ID | `tester2.customer@thetasteofandhra.com` |
| Password | `Test@123` |
...
| Field | Value |
|-------|--------|
| Email / User ID | `tester2.admin@thetasteofandhra.com` |
| Password | `Test@123` |
...
| Field | Value |
|-------|--------|
| Email / User ID | `tester2.delivery@thetasteofandhra.com` |
| Password | `Test@123` |
...
3. **Admin** — confirm order and assign **Tester 2 Delivery**
...
- Password for all Tester 2 accounts: **`Test@123`**
